.. topic:: Operations: Engineering and Automation
...
.. topic:: 1.1: Where Ive Been, What Ive Been Doing, Why I Wrote this Book
...
.. topic:: 1.2: The promise of automation is removing classes of work
...
.. topic:: 1.3: Writing in the First-Person
...
.. topic:: 1.4: Writing Stylistic Conventions
...
.. topic:: 2.1: The differences between Physical and Virtual: Real and Unreal
...
.. topic:: 2.2: I only really know what I myself have experienced
...
.. topic:: 2.3.1: Operations is about Control
...
.. topic:: 2.3.1.1: "De facto" Ops vs. "Planned/Controlled" Ops
...
.. topic:: 2.3.1.2: Alignment takes "vision" and knowledge
...
.. topic:: 2.3.2: An Explanation of Operations
...
.. topic:: 2.3.2.1: How is this not a core-service?
...
.. topic:: 2.3.2.1.1: Just because it's Core doesnt mean...
...
.. topic:: 2.3.2.1.1.1: Typically companies still don't...
...
.. topic:: 2.3.2.1.1.1.1: The Ops department is blamed for all lag
...
.. topic:: 2.3.2.1.1.1.1.1: Everyone doing everything themselves is...
...
.. topic:: 2.3.2.1.1.1.1.2: What can be self-service, and what cant
...
.. topic:: 2.5.1: Philosophers Knife
...
.. topic:: 2.5.2: Slicing the pie vs aggregation
...
.. topic:: 2.5.4: Inputs, Outputs and Side-Effects: A Virtual Mechanism
...
.. topic:: 2.6.3: Rules: policies about how you do stuff
...
.. topic:: 2.6.4: Distributed: dealing with N nodes
...
.. topic:: 2.6.5: Real/Virtual.  Strict definitions.
...
.. topic:: 2.6.5.1: Be clear about the differences:  Physical (Real), Logical (Virtual), Data (Virtual)
...
.. topic:: 2.6.5.1.1: Reality: The Physical
...
.. topic:: 2.6.5.1.2: Virtual: The Un-Real
...
.. topic:: 2.6.5.1.2.1: However, between Data and Logic is a huge gap, as Data is "perfectly" understandable, while Logic is not, due to Halting Problems and all other things CS-academia knows and describes very well.
...
.. topic:: 2.6.5.1.2.2.1: Changes to data, that meets constraints, will not harm other data, but can harm Logic that acts on the data (results of Logic, rather)
...
.. topic:: 2.6.9: Operational Environments
...
.. topic:: 2.6.9.1: Production Environment
...
.. topic:: 2.6.9.5: Corporate Environment
.. topic:: 2.6.10: Server
.. topic:: 2.6.11: Device or Machine or Nodes
.. topic:: 2.6.12: Humans
...
.. topic:: 2.7: The Philosophy of Pragmatism
...
.. topic:: 3.1.1: A brief interlude on the Strengths and Weaknesses of Metaphors
...
.. topic:: 3.2: Difference between Application and Operational Logic
...
.. topic:: 3.2.1: Many applications and services.  One Operational environment
...
.. topic:: 3.2.1.1: Making more dependencies.
...
.. topic:: 3.2.1.2: Like 1 big computer.
...
.. topic:: 3.3: Axiomatic Engineering
...
.. topic:: 3.3.1: 90-9-.9-.09% Rules for Priorities
...
.. topic:: 3.3.1.1: Assigning different people different priorities is what makes up different roles.  This allows different points of view, to make the organization stronger and more thoughtful, by design.
...
.. topic:: 3.3.2: Creating Axioms from Axes
...
.. topic:: 3.3.2.1: Impersonal decision making through communicated values and priorities using Axioms
...
.. topic:: 3.3.3: Fashion Oriented Engineering
...
.. topic:: 3.4.2: The Problem with the "Best"
...
.. topic:: 3.5: Understanding Engineering
...
.. topic:: 3.5.1: The Use of Resources
...
.. topic:: 3.5.1.1: Evaluate the environment.  Know the present.  Real vs. Virtual.
...
.. topic:: 3.5.1.2.1: Black-Boxing the World
...
.. topic:: 3.5.1.4: Centralized vs. Decentralized
...
.. topic:: 3.5.1.5: Distributed Systems
.. topic:: 3.5.1.6: Distributed Data
.. topic:: 3.5.1.7: Hardware: Fixed vs. Utility vs. Cloud
.. topic:: 3.5.1.7.1: Fixed Hardware
.. topic:: 3.5.1.7.2: Utility Hardware
.. topic:: 3.5.1.7.3: Cloud Hardware
.. topic:: 3.5.1.7.3.1: *aaS

Everything as a Service.
.. topic:: 3.5.1.7.4: What do you have to care about?
.. topic:: 3.5.1.8: Types of Complexity
...
- Detail Complexity
.. topic:: 3.6: Code management
.. topic:: 3.7: Perfect is the enemy of done
.. topic:: 3.7.1: Quality is Never #1; Utility is Always #1
.. topic:: 3.7.2: Security Is Also Not #1
.. topic:: 3.8: Troubleshooting
.. topic:: 3.8.1: Monitoring
.. topic:: 3.8.2: Spectrums
.. topic:: 3.8.2.1: Comparisons
.. topic:: 3.9: Skill Ladders
.. topic:: 3.9.1: Graphing Skills
.. topic:: 3.9.2: Understanding Your Own Ladder
.. topic:: 3.10: When to use Statistics
...
.. topic:: 3.10.1: Across many things: Appliable
.. topic:: 3.10.2: For a given thing: Not Applicable
.. topic:: 3.10.3: Exercises
.. topic:: 3.11: How to Select Tools
.. topic:: 3.11.1: Many stand alone tools will end up being replaced
.. topic:: 3.11.1.1: Text and data and the purpose of the tools
.. topic:: 3.11.1.2: Explain Replacement of DNS, DHCP, etc
.. topic:: 3.11.1.2.1: Zones, Subnets, etc
.. topic:: 3.12: Name spaces
.. topic:: 3.13: Structure as Logic
...
.. topic:: 4.1: ***** Removing classes of work.
.. topic:: 4.1.1: Manual automation is a force multiplier.  Mistakes are also multipled.  Unintended consequences can be severe and wide-spread.
.. topic:: 4.1.2: Making people do more complicated and dangerous activtiies should not be an end-goal of automation, though it will likely be an intermediary step.
.. topic:: 4.1.2.1: Step with caution.
.. topic:: 4.2: Introduce spectrum of automatability.  How automateable is something in configure X vs Y?  This is automatability.
.. topic:: 4.3: Working with N axis data for evaluation of properties.  Properties are scalar, but there are many dimensions to measure, and collectively they are near-infinite.
.. topic:: 4.3.1: Tuning your goals based on your methods.
.. topic:: 4.3.2: How to create your own Axioms.  Some standard axioms.  Axiomatic development.
.. topic:: 4.3.3: Tools to fit the job.  Testing in an operational environment.  Mock-tests, etc in a world of only side effects.  Using Vagrant and VMs to test allows these side-effects to be tested, but take time to set up.  Worth it, but you may not start there in a live environment because of all the legacy that would have to be replicated and is changing all the time in non-standard ways.
.. topic:: 4.3.4: How to standardize things.  Simplification.  The benefits and limitations.  Simpler means less options at any given time.  1-1 work is infinite precision and difficult to scale.  Simpler is can be deep precision in 1 or several ways, but does not allow all options.  Build your option matrix out of what you need, ensure all your use cases are covered.
.. topic:: 4.4: All processes can be automated to get a desired effect, if enough information about it is known.
.. topic:: 4.5: Introduce Intelligence.  Actionable Intelligence.
.. topic:: 4.6: Automating anything
.. topic:: 4.6.1: Pre-Solving Problems
...
.. topic:: 4.7: Total elimination of manual work.  How to remove classes of work from being necessary.
.. topic:: 4.8: Building the data and action chains, to create all workflow.
.. topic:: 4.9: The data requirements:  Authentication, Authorization, Versioning, Change Management, Deployment, Pre-Post Deployment Actions, Schema Management
.. topic:: 4.10: How to construct an unbreakable process.  How to stop that process from being completed/sealed, so that it breaks.  How to ensure it breaks all the time, by setting conditions accordingly.
.. topic:: 4.10.1: Faux-automation.  Manual automation.  Automation-assist.  Full-automation.  Comprehensive Life-Cycle automation.
.. topic:: 4.10.2: This can be started as Procedure for Humans, but it will not be unbreakable, as people will make mistakes entering data (running commands is entering data)
.. topic:: 4.10.2.1: Entered on the right system?  Right command?  Right args?  Right path?  Right data?  Right goal?  Right everything?
.. topic:: 4.11: Flexibility and dangers of an automation system.
.. topic:: 4.12: Distributed OS.  DOS.  N units, all being controlled, configured and scheduling work.
.. topic:: 4.12.1: Does not need a "traditional" cluster scheduler.  Can use these these for "cron" type jobs though.
.. topic:: 4.13: Monitoring is the heart of automation.  You cant control what you dont have info on.
.. topic:: 4.13.1: Instelligence:  Actionable?  Timely?  Relevant?  Correct?  (Cross check it, all must align)
.. topic:: 4.14: Behavioral AI.  An expert system, build by experts in Ops and Biz goals.
.. topic:: 4.14.1: Do not use fuzzy info until you have exhausted discrete/precise info.  And turn the fuzzy info into a discrete/precise data point, so it can be acted on cleanly by logic.
.. topic:: 4.14.2: N of M failures is not fuzzy, even though it has a scalar value, and not boolean.
.. topic:: 4.15: 3 States:  Now, Desired, Current State (Whats Out there?)
.. topic:: 4.15.1: How to manage.  Importing, synthesizing, checking.
.. topic:: 4.15.2: Versioning, commits, pre/post-commit logic.
.. topic:: 4.16: Agent model.  Centralized model.
.. topic:: 4.17: Library model.  RPC model.  Framework model.
.. topic:: 4.18: ORM vs wrapping lib vs straight SQL/data query.
.. topic:: 4.19: Scales,  1000s/millions, not billions.  Can make this "configuration scale" not "production deployment end-user scale".  Optimize only when necessary, use tools that do heavy lifting for Time series data analysis, and import results and last N snippets into OpsDB.
.. topic:: 4.20: Selective Data Updating for Pyramid method and Mesh method.
.. topic:: 4.21: Compare Pyramid vs Mesh (p2p).  Pros and cons.
...
.. topic:: 5.1: Requirements
.. topic:: 5.2: Resources
.. topic:: 5.3: Goals
.. topic:: 5.4: Logic
.. topic:: 5.5: Environments
.. topic:: 5.6: Processes
.. topic:: 5.6.1: Adding Features
.. topic:: 5.6.2: Fixing Bugs
.. topic:: 5.6.3: Improving Efficiency
.. topic:: 5.6.4: Performing Maintenance
.. topic:: 5.6.5: Designing a New Version of a System
...
.. topic:: 7.1: The process of building this system in your organization.
.. topic:: 7.1.1: Collect all unique data in one place.  Ensure it is accurate by checking against reality, and combing through it manually to see if things line up, spot checking and automation checking every one by script.
.. topic:: 7.1.2: Things that are unique to you, vs things that are general to everyone.
.. topic:: 7.1.2.1: FQDNs, IPs, HW specs, OS specs, configuration variables, specific workflow and stuff.
.. topic:: 7.2: Imaging vs re-building from scratch
.. topic:: 7.2.1: Correctness, up-to-date, vs speed.
.. topic:: 7.3: *** The Progression of an Automation System:  Walk through all the stages **
.. topic:: 7.3.1: These shouldnt be an order so much, as people can take different routes.   How to evaluate each of these spectrums/axis of data, scalars, would be good.
.. topic:: 7.3.2: Manual everything
.. topic:: 7.3.3: Kickstarts and auto config  (AWS gets you here)
.. topic:: 7.3.4: Sys configuration tools, Monitoring, Centralized Logging, etc.  Normal sys admin process.
.. topic:: 7.3.5: Issue tracking systems, change management ticket systems.
.. topic:: 7.3.5.1: Good to have different CMS for tickets, because your ops logic will change, but its more useful to track the CMS data right in the ops db for a real record of things, because it lists the complete workloads.
.. topic:: 7.3.6: Databases for assets, inventory, etc
...
.. topic:: 8.1: What is it?
.. topic:: 8.1.1: Your OpsDB is the desires and actionable knowledge of your company.  Everything inside it can be acted upon, it is better global information than any single person can have, so it is the best communication mechanism for a system that has multiple people with their own information (all companies over 1 employee).  Synchronizes information, makes transactional.
.. topic:: 8.1.2: Setting realistic expectations for this project will be one of your biggest challenges.  Once the premise is understood, it is difficult to stop "magical" thinking about the project, as the intention is to solve all solvable problems, people see it as a magic machine.
.. topic:: 8.1.3: It is a system or "machine" that can be used to solve all problems, in that it is a centralized database and method for acting against that data.  That is immediately a universal set of tools, because every piece of software is data with a method for acting against it.
.. topic:: 8.2: Data Driven Design:  My methodology.  Start with the data, work from there.  Testing against data is key.
.. topic:: 8.2.1: Separate data changing logic from non-data changing logic.  This is like the Model/Controller separation, but is different because it is about any type of action, not just GUI-like actions.
.. topic:: 8.2.2: Work systems.  Distributed Job schedulers.
.. topic:: 8.2.3: Collection of data:  Events (logs/etc), Time Series, Config State (md5sum, etc), Active/Live State (up/down)
.. topic:: 8.2.4: Data Driven Development.  My methodology.
.. topic:: 8.2.4.1: Start with data.  Fo over all features as represented in data.
.. topic:: 8.3: The Data (base)
.. topic:: 8.3.1: Modeling off of reality.  Logical ideas change all the time, business decisions and directions change all the time, staff changes regularly, reality will hold true, but it's perceived differently by everyone.  Still trying to map to reality gives the most common information to the most people who will work with it, and a common method of communication, and is therefore better than not.
.. topic:: 8.4: Naming conventions.  Set them and try to abide by them consistently.  This will determine how frequently things must be looked up to be used, for someone familiar with the sytem.  Python vs PHP.
.. topic:: 8.5: My rules:  No plurals in data (code is ok), strict lookup methods, limit methods of relationality.  DAG lookups, with normalized relations in data (not-DAG, has cycles, data doesnt have a direction when there are cycles, the search could start anywhere).
.. topic:: 8.6: What tools you will need to manage this data.   Problems with ORM, problems with non-ORMs.  The tools chosen will determine the level of automatability.
.. topic:: 8.7: Building the logic system.
.. topic:: 8.7.1: Ensuring uniqueness of elements that require guarantees.
.. topic:: 8.7.2: Infrastructure.  Pre-Services.
.. topic:: 8.7.3: Configuration of Services.
.. topic:: 8.7.4: Monitoring of Services.
.. topic:: 8.7.5: Life-Cycle Management of services.
.. topic:: 8.8: The layers of an automation system:
.. topic:: 8.8.1: Description of environment
.. topic:: 8.8.2: Provisioning
.. topic:: 8.8.2.1: One-Time configuration
.. topic:: 8.8.2.2: Continuous Configuration
.. topic:: 8.8.2.3: State management
.. topic:: 8.8.2.4: One-time actions (manual state control of distributed systems)
.. topic:: 8.8.2.5: Maintenance actions (taking offline)
.. topic:: 8.8.2.6: Marking broken HW, fixing HW, migrating OS positions.
.. topic:: 8.8.2.7: What stays the same, what changes?  IPs for LOM on HW.  IPs for OSes on virtual.
.. topic:: 8.8.2.8: Tracking N things.  Primaries vs. position.  Ordered lists are the best?
.. topic:: 8.9: How to "translate" data changes, making many changes at once, like matrix multiplication.  Changing from Puppet to Salt, etc.
.. topic:: 8.10: How to Build your own OpsDB.  What you need:
.. topic:: 8.10.1: View (Webpage, API)
.. topic:: 8.10.2: DB Backend
.. topic:: 8.10.2.1: Method for safely making changes to data
.. topic:: 8.10.2.1.1: Versioning, Change Management
.. topic:: 8.10.2.1.1.1: Roll backs
.. topic:: 8.10.2.1.1.2: Pre-Post Commits
.. topic:: 8.10.2.1.1.3: Locking, to stop problematic race conditions
.. topic:: 8.10.2.1.1.3.1: Channeled locking, to limit domains of locks
.. topic:: 8.10.2.1.1.3.1.1: Size of domain, and rate of change and lock duration determine requirements
.. topic:: 8.10.2.1.2: Single choke point for DB changes
.. topic:: 8.10.2.1.2.1: Web/API all use the same code, so different paths give different results.
.. topic:: 8.10.2.1.2.2: Role users (scripts) can auto-commit changes, but should go through same process, because needed for auditing, troubleshooting, and maintaining integrity and pre/post-commit logic
.. topic:: 8.10.3: Pull method, to gather data.  Time Series, Logs, State/Configs, Events, etc
.. topic:: 8.10.3.1: Creates Global Authority DB
.. topic:: 8.10.3.1.1: Can be distributed, if sync. is strong
.. topic:: 8.10.3.1.1.1: Need Transactions on all pieces of total DB, so that things are changed in block fastion, all this way, then all that way.  Keeping alignment.  (Like a shot in Pool, game.  Stick and balls must line up to make it into the pocket.)
.. topic:: 8.10.3.1.1.2: Will come later in the process, in the "How to implement" section
.. topic:: 8.10.3.1.2: Selective Replication.  Will have local and global portions.   Easy to separate instances (2 MySQL instances) so taht there is a Global DB (replicated from Master) and a Local DB, pulled from Local, which replicates to Master.
.. topic:: 8.10.3.1.2.1: In this scenario, the Master will need to have N instances, where N is the number of sub-masters, so it can replicate.  Then it will pull and integrate this data into it's own global system, and then synthesize.
.. topic:: 8.10.3.1.2.1.1: This Global pull-integrate-synthesize is then replicated out everywhere, and is the REAL data that can be acted upon.  It has met all constraints and has a view into everything
.. topic:: 8.10.3.1.2.1.1.1: Some Logic can run off of Local data, because it is locally concerned.  When Logic needs to act on Global data, its obvious it needs to be correct and current global data.  Intelligence.
.. topic:: 8.10.3.1.2.2: Collection is local.  Work from Global.
.. topic:: 8.10.3.1.2.2.1: How to work on partitioon?
.. topic:: 8.10.3.1.2.2.1.1: Can use local data for N time, until is stale.  Logic can decide how stale the data can be, can have Rules for lag time allowances.
.. topic:: 8.10.4: Orchestration.  Remote Execution.  Seall the loop and check.  Post-Provisioning will need to run commands to check that things really worked.  Same as any other type of action. Do the action, get the result, but then go check and make sure it worked.  Check again to see if it failed after some time.  Ensure another action hasnt caused this (acted on the same Resource)
.. topic:: 8.10.5: Config Management.  Make known changes on a system.  It should be in "X state"
.. topic:: 8.10.6: State Management.
.. topic:: 8.10.6.1: OS Level
.. topic:: 8.10.6.2: Service level (dealing with the execution of services, and proper functionoining of the service)
.. topic:: 8.10.6.3: Running-Service level (dealing with things inside a running service.  This is a user of the service, instead of a controller, but it is an "administrative" type of use)
.. topic:: 8.10.7: Work Scheduling
.. topic:: 8.10.7.1: Global cron jobs, etc.
.. topic:: 8.10.7.1.1: In maint?  Is right machine (master/slave/role/etc)?  Dont take down prod.
.. topic:: 8.10.7.1.2: Dont ignore failures of jobs.  Keep logs for auditing, so we know what happened, and what it happened for troubleshooting and Root Cause Analysis.
.. topic:: 8.10.7.1.3: Track times for analysis to determine failures of scale-performance changes
.. topic:: 8.10.8: Capacity Planning.  When will you run out of:  Disk? RAM?  CPU? Connections?  etc
.. topic:: 8.10.8.1: Resources of our services.  Network Loadbalancer has N potential connections, and we can determine that by a MAX check on how much its done, and where it has produced failures after MAX_WORKING values have been breached.  Might not be the LB though, just correlation.
.. topic:: 8.10.9: Access Control.  Authorization to do work.
.. topic:: 8.10.10: Security zones
.. topic:: 8.10.10.1: Environments and Security Zones
...
.. topic:: 8.10.10.2: Tiered Security Zones
...
.. topic:: 8.10.10.3: Security Zones Inside Environments
.. topic:: 8.10.11: Deployments, as separate from Config
.. topic:: 8.10.11.1: Code deploy
.. topic:: 8.10.11.2: Data/Schema deploy
.. topic:: 8.10.11.2.1: When tied together.  Ways to avoid problems, ways to increase problems.
.. topic:: 8.10.11.2.2: Lifetimes, rate of change, etc
.. topic:: 8.10.11.2.3: Service up/down.  In/out of LB.  (Active)
.. topic:: 8.10.12: Network config and planning
.. topic:: 8.10.12.1: VLANs.  Hidden systems, ensure not old IPs (collisions)
.. topic:: 8.10.12.1.1: Can defer their use until that HW is proven to not use that IP anymore.  Like its in Escrow.  Once really released, it can be re-used.   Nice.
.. topic:: 8.10.12.2: LOM IPs stay with the hardware.  DHCP timeouts, etc.  Server IPs stay with "ServerInstance" (OSInstance)
.. topic:: 8.10.13: VM Provisioning.  Hybrid.
.. topic:: 8.10.14: Self Service tools.
...
.. topic:: 9.1: The OSI layer for getting things done:
.. topic:: 9.1.1: Physical.  Real world things.
.. topic:: 9.1.1.1: People are always required for real world things, because robots arent good enough yet.  Physical must manage physical.
.. topic:: 9.1.2: Configuration.  How real world things are configured.
.. topic:: 9.1.2.1: Logical.
.. topic:: 9.1.3: State.  How real world things are managed.
.. topic:: 9.1.3.1: Logical.
.. topic:: 9.1.4: Automation.  How software can manage configuration and state.
.. topic:: 9.1.4.1: Automation ends where people begin.  If you have no automation, the people manage the config and state.
.. topic:: 9.1.4.2: Automation is the control of logical devices and state.  It does not control Physical devices, but does control their state.  (Even in the case of directing a physical robot, the automation updates state, and it takes something physical (motors, servos, cogs) to make the physical thing move.)
.. topic:: 9.1.5: Process (and Procedures).  How people work around the lower levels.
.. topic:: 9.1.6: Policy.  Dictates how processes can be implemented.  Policies may be directly contradicting Process, such as "No one is allowed to X", while a process requires a person to do exactly that.
.. topic:: 9.1.7: Business...  Business goals
.. topic:: 9.1.8: Political.  The realities of the business goals, determined by how well people will work together to achieve them.
.. topic:: 9.1.9: Financial...  Financial reality, approved or not.  Timing.  Delays.
.. topic:: 9.1.10: Legal...  Hard stop, must change direction if told by legal.
.. topic:: 9.2: Planning for projects in the real world
.. topic:: 9.2.1: The end-date comes first.  Whether you have any say in that is only occassionally true, even if you are asked how long it will take.
.. topic:: 9.2.2: Things will interrupt your work that were not planned for in the time estimates, and this will mean less work gets done
.. topic:: 9.2.3: You will have normal duties to attend to, this will interrupt things getting done
.. topic:: 9.2.4: Meetings.  Whether you enjoy them, are ambivalent, or dislike them, they are going to occur and take time.
.. topic:: 9.2.5: Mental-Context-switching cost.  Ramp up time.
.. topic:: 9.2.5.1: Know what kind of work you are going to start, and pick the best time to do so.  If it needs more ramp-up time, then pick a block where you are less likely to be interrupted.
...
.. topic:: 10.1: Universal Machines as infinite recursive abstraction
...
.. topic:: 10.2: Single Layer Systems
...
.. topic:: 10.3: Multi-Layer Systems
...
.. topic:: 11.1: Go over code reviews, and config reviews.
.. topic:: 11.1.1: *** Mark this as my personal opinion.  Not as something provable.  This is color. ***
.. topic:: 11.1.2: Normal pitfalls.  Dont really check, "Yes Stamp".
.. topic:: 11.1.2.1: Too style oriented.  Enforcing a style is important in some areas, but less important in others.  It is better to keep a team cohevsive to know these differences, so that on some things you are strict (variable naming) and on other things you are flexible (commenting style).  People write prose more personally than they name variables, and variables have to be used by many people, whereas the message in a comment in based on the author's mental state when they wrote it, which is very subjective, and people have very different styles.
.. topic:: 11.1.2.1.1: I recommend allowing people to have their own unique style in areas that will not harm the ease-of-use and resiliency/robustness of the Logic, and strictness on naming conventions, and basic formatting (indentation)
.. topic:: 11.1.2.1.1.1: Strictness can be kept inside individual projects, with a general theme to a department or company.  These are degrees to each of this which will make actually working with other people nicer, while
.. topic:: 11.2: Root Cause Analysis write ups.
.. topic:: 11.2.1: How to not bullshit these.  Dont lie.  Dont criticize every failure, because failures WILL happen.  The only way to avoid them is to REMOVE the CLASS OF WORK.
.. topic:: 11.3: Create a set of Checklists.
.. topic:: 11.3.1: Automation Spectrum
.. topic:: 11.3.2: Automation Layers
.. topic:: 11.3.2.1: Sub-Components of layers.  How well are they implemented, 1-5 scale or something
.. topic:: 11.3.3: Talk about how to make your own checklists and scales.  This is flexible, not dogmatic.  The important part is that we can communicate what we are talking about, in a way where multiple individuals and groups can agree, allowing us to work successfully together.
.. topic:: 11.4: Self-evaluation?  How to evaluate your actions, how to make plans to improve.
.. topic:: 11.5: Introduce the Basic Laws of Human Stupidity.  Not meant as insult or joke, but as quantitative method of determining the intelligence of an action.  This is the model I will use in this book.
.. topic:: 11.6: Journmanship, apprenticeship.  What we are missing.  Valuing experience.  Im old, of course thats my take.
.. topic:: 11.7: The benefits of "vanilla" use of tools.  Less upkeep.  Only change what you strictly need to change.  Spend time optimizing only in critical areas.  Reduce things that need to be manually maintained.
.. topic:: 11.8: "Lowest Common Denominator" problem
...
.. topic:: 11.8.1: "Best Practices" Means Not-Thinking
...
.. topic:: 11.9: The Similarities of All Code
...
.. topic:: 11.10: Penalties of Over-Abstraction
...
.. topic:: 11.11: Releasing the poison
...
.. topic:: 11.12: Randomly Collected Spectrums
...
.. topic:: 11.13: How To Make A Decision
...
.. topic:: 12.1: Have "Wouldnt it be nice?" sections, where I posit what would be improvements I have yet to experience.  Coming to terms, agreeing on the foundational details, agreeing on the axioms, agreeing on how to relate data to the axioms.  Agreeing on how to act against axioms.  With these done, we can work much better as a team, and discuss them.
