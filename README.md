...
<br>
Achieving business goals is the reason all departments exist, so it is a good thing to get the work done, but it can be performed in a manner where the business begins to not operate efficiently, and eventually starts to fail frequently, causing harm to other business goals, such as customer retention, which effects revenue.<br>
<br>
