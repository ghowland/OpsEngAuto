...
<br>
For the purposes of reading this book, please accept my definitions as I will use them in this book for the purpose of making things clear, so the definitions must mean what I say to get the results of what I'm trying to convey to you.&nbsp;&nbsp;If it helps you can mentally append "Geoff is saying he means X when he says Y in this book", if the terminologies conflict too much with your existing use of the words.&nbsp;&nbsp;I'm making a specific point about this, as I often have an internal feeling of rejecting an authors information based on their use of words from being different than how I would use them.<br>
<br>
