...
<br>
If we were in the meeting we could qualify the assertion that this was related to an ISP maintenance notification we received by comparing that to the data known to correlate that assertion with the actual outage. <br>
<br>
