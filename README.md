...
<br>
As an example, say there are a pair of relational databases in a Master/Slave configuration, and the Master node fails, because of the priorities for Application Logic, generally the application will just fail until the Master/Slave designators are flipped (floating IP address or DNS name change, or from another directory-style service).&nbsp;&nbsp;<br>
<br>
