...
<br>
The curse of an expert is a real thing, and doesn't just ruin movie plots ("They stole the floppy disk with all our vital information!", "We are 10 digits into hacking the mainframe, but they are using 49-bit encryption, it will take a while."), but also can ruin the intention of any type of alternative explanation, which is trying to expand on an idea in a hand-wavy-kind-of-way.<br>
<br>
