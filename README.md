...
<br>
Dividing between Kernel and User space splits all code that is executed by the operating system.&nbsp;&nbsp;We can take the same system, and make a cut between "firmware" (code that executes from BIOS and other places closer to hardware) and "software", which is executed from RAM on the main CPU.<br>
<br>
