...
<br>
Achieving business goals is the reason all departments exist, so it is a good thing to get the work done, but it can be performed in a manner where the business begins to operate less efficiently, and eventually starts to fail frequently, causing harm to other business goals, such as customer retention, which effects revenue.&nbsp;&nbsp;So both getting the work done, and getting the work done in a way that improves the ability to do more work in the future is important.<br>
<br>
