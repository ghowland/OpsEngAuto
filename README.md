...
<br>
The Data Source may be persistent, or it may be temporary (such as Javascript data in a web page).&nbsp;&nbsp;It may be transactionally safe, or unsafe to update in treads.&nbsp;&nbsp;These are secondary properties, as the primary property of a Data Source is access to the data.<br>
<br>
