...
<br>
- One instance of something.&nbsp;&nbsp;This is when you have one thing that you use; it is the centralization of a service.&nbsp;&nbsp;There may still be a pair of machines (Master/Slave) supporting this one-thing, and there may be more than a pair, but if there is logically a "single instance" of the thing, then it is a "one instance".<br>
<br>
