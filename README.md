...
<br>
For instance, we can look at an Operating System that runs on hardware (like Linux, OS X or Windows), and divide the it into code that runs in "Kernel space" vs code that runs in "User space".&nbsp;&nbsp;We could call this the "Kernel space cut", to determine "Is Kernel space?" vs "Is not Kernel space?".<br>
<br>
