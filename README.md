...
<br>
Because the topics are specific, and the numerical values gives your preference (or could be data collected through automation or monitoring) for what these very specific things should be, and if you have related concepts that are specifically explained in contrasting axises, then the resulting quantified numbers of those axises can give deeper insight to the problem, and can be communicated.<br>
