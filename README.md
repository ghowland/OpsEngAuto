...
<br>
Sometimes it is a problem that people just forget to do one of the steps, although since the new machines wont have DNS names, people will only be able to reference them by IP address, so usually the problem is quickly remedied.<br>
<br>
