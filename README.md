...
<br>
To be safe, the journal is written to and flushed to disk before the "changes are made" in the data source, so if anything the internal database data is consistent with the previous changes, and only new journal entries need to be applied.<br>
<br>
