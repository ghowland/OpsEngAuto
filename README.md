...
<br>
The reason for this is the difference between a comprehensive system (correctly sliced with the Philosopher's Knife), and an aggregated system (imagine building something up from bricks, instead of slicing an existing pie), which is built not as a complete system that is sliced into pieces of the pie that can be put together to form the whole, but is aggregated from components.<br>
<br>
