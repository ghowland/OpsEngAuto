...
<br>
There are some operations, such as dumping data and mass-importing it, that can cause these checks to be turned off, so be careful when you do this to do everything that is involved at the same time (ex: dump all tables that reference each other), to ensure that you have not imported things into an inconsistent state.<br>
<br>
