...
<br>
A system can be described by a network of black box functions which take inputs, emit outputs, and perform side-effects, totaling the results of anything that exists or doesn't exist.&nbsp;&nbsp;Either way, it can be described as a system, and using this methodology for organizing one's thoughts is "systemic thinking" by my definition here.<br>
<br>
