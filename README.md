...
<br>
Since this is not a digital or a single-downward-vector scale (as we generally use these days), but a lever or fulcrum scale (I don't actually know the technical terms for these scales, so just making up what makes sense to me), it has two sides, and not just a single platform.<br>
<br>
