...
<br>
Making a change requires both defining the goals we want to achieve, and the current state of things, so we know what is required to make a change to get to our goals.<br>
