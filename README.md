...
<br>
For instance, in our web request and logging examples, we have determined that without log rotation we will in time fill up available storage, and fail to be able to take more requests (and log their results), and so we are sure to have failures on any active systems where this is the case.<br>
<br>
