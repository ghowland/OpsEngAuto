...
<br>
Grouping everything into only one single pool of "effects" is the better way to do this, when you care about accuracy and clarity, because you are not trying to push anything to the "side-lines" and are seeing all effects as being caused by your action, and thus will evaluate that action more comprehensively.<br>
