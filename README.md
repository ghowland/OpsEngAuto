...
<br>
How do we get the "best" (most) up-time?  Well, the most important thing is actually a "negative", which is "don't go down".  However, "not going down" takes "all the things" working all the time, even when things fail.  This is obviously a very complicated endeavor to try to improve.<br>
<br>
