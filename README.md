...
<br>
This is yet another tool for performing evaluations, by making one example, and rating it, and then making another (or a series of others) example, and rating those, and then going back and re-rating the first/early example, then the second again, and finally creating examples of the most extreme situation you can imagine at both ends of the spectrum (being 0.0 and 1.0), and then re-evaluating the middle ones again.&nbsp;&nbsp;This is a method for getting a numerical sense of an information space.<br>
<br>
