...
<br>
When querying the attendee who offered the assertion, they would explain that they didn't verify this was the case, but it matches the time frame of the notification.&nbsp;&nbsp;We can conclude from this that while this is a possible lead to look for correlating data/evidence, it is not a candidate for Root Cause because there is no data.<br>
<br>
