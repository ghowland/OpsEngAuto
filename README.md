...
<br>
In these "tool" types of Logic, it is the data that tells the Logic how to achieve a goal, and so again the Data gains primacy over the Logic in being the key element.&nbsp;&nbsp;The Logic only exists to transform the Data.<br>
<br>
