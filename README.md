...
<br>
So Philosophy is the "love of wisdom", and I love wisdom, so I take it for that.&nbsp;&nbsp;I orient myself on "Applied Philosophy", which is using Philosophy in a way that I can use to achieve results (internally and externally) and not merely as a way to win arguments at dinner parties, or making comments that end with "Do you want fries with that?".&nbsp;&nbsp;<br>
<br>
