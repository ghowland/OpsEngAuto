...
<br>
- Why am I doing this?  What are my goals?  How can I define them precisely?  Is my entire team in agreement with this, as an intention?  Are we able to communicate effectively, ensuring that what understand each other and can work together efficiently?  How would know if this is true, and we are succeeding?  How can we measure that success, and compare it to the goals we wanted to achieve before we started?<br>
<br>
...
<br>
This is a "Turing Machine" in which we know it will never halt.  There is no final exit or return from Philosophy, it is a rabbit hole that never ends, and goes as deep as you are willing to look.<br>
<br>
